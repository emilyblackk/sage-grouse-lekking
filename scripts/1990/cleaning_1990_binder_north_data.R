#Emily Black
#Cleaning 1990 binder data - north lek 
...
original_joined_df <- read.csv("prelim_clean/binder_capture_data_prelim.csv")

#read in the north lek data 
df_1 <- read.csv('raw_data/binders/north_lek_1990_capture_binder_data.csv', 
                 header=FALSE)
...
df_2 <- read.csv('raw_data/binders/north_lek_1990_capture_lab_binder_data.csv', 
                 header=FALSE)

...
previous_capture <- read.csv("prelim_clean/binder_capture_data_1987_prelim_CL_BW.csv")
...
#Write to github
write.csv(full_capture, "prelim_clean/binder_capture_data_1987_prelim_CL_BW_MS.csv", 
          row.names=FALSE)

#Emily Black
#Cleaning 1989 strut data - mud_springs
...
df_1 <- read.csv('raw_data/binders/mud_springs_1989_strut_binder_data.csv', 
                 header=FALSE)
...
table(df_wider$type)
#there are 121 struts from the floppy, 
#and 129 in our dataframe
...
previous_strut <- read.csv('prelim_clean/1989/merged_struts_binders_floppy_1989_C_MC_NM_SF_LL_N_VP.csv')
...
#write to computer
write.csv(final_strut, 'prelim_clean/1989/merged_struts_binders_floppy_1989_C_MC_NM_SF_LL_N_VP_MS.csv',
          row.names=FALSE)

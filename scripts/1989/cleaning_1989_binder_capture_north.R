#Emily Black
#Cleaning 1989 binder data - north
...
df_1 <- read.csv('raw_data/binders/north_1989_capture_binder_data.csv', 
                 header=FALSE)
...
previous_strut <- read.csv("prelim_clean/binder_capture_data_1989_prelim_CL_LL.csv")
...
#Write to save
write.csv(final_strut,  "prelim_clean/binder_capture_data_1989_prelim_CL_LL_N.csv", 
          row.names=FALSE)

#Emily Black
#Cleaning 1989 binder data - cordingly
...
#read in the cordingly lek data 
df_1 <- read.csv('raw_data/binders/cordingly_1989_capture_binder_data.csv', 
                 header=FALSE)
...
#previous_strut <- read.csv("prelim_clean/binder_capture_data_1989_prelim_CL_RP_LL_WD_MS_N_SS_V.csv") 
...
#Write to save
write.csv(df_1,  "prelim_clean/binder_capture_data_1989_prelim_CL.csv", 
          row.names=FALSE)

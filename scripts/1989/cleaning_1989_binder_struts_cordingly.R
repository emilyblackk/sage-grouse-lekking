#Emily Black
#Cleaning 1989 strut data - cordingly
...
df_1 <- read.csv('raw_data/binders/cordingly_1989_strut_binder_data.csv', 
                 header=FALSE)
...
table(df_wider$type)
#there are 6 struts from the floppy, 
#and 6 in our dataframe
...
#correct a date error in floppy
strut_filtered$day[6] <- 6
...
#previous_strut <- read.csv('prelim_clean/1989/merged_struts_binders_floppy_1989_C_BW_RP_LL_WD_MS_N.csv')
...
#write to computer
write.csv(filtered_df_full_join, 'prelim_clean/1989/merged_struts_binders_floppy_1989_C.csv',
          row.names=FALSE)

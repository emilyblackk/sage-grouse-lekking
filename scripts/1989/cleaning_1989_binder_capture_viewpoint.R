#Emily Black
#Cleaning 1989 binder data - viewpoint
...
df_1 <- read.csv('raw_data/binders/viewpoint_1989_capture_binder_data.csv', 
                 header=FALSE)
...
previous_strut <- read.csv("prelim_clean/binder_capture_data_1989_prelim_CL_LL_N.csv")
#rename blood_leuko as blood_haema
previous_strut <- previous_strut %>%
  rename(blood_haema = blood_leuko)
...
#Write to save
write.csv(final_strut,  "prelim_clean/binder_capture_data_1989_prelim_CL_LL_N_VP.csv", 
          row.names=FALSE)

#Emily Black
#Cleaning 1989 strut data - long_lake
...
df_1 <- read.csv('raw_data/binders/long_lake_1989_strut_binder_data.csv', 
                 header=FALSE)
...
table(df_wider$type)
#there are 74 struts from the floppy, 
#and 86 in our dataframe
...
#manually correct an error in dates
strut_filtered$day <- ifelse(strut_filtered$month == '4' & strut_filtered$day == '17', '18', strut_filtered$day)
...
previous_strut <- read.csv('prelim_clean/1989/merged_struts_binders_floppy_1989_C_MC_NM_SF.csv')
...
#write to computer
write.csv(final_strut, 'prelim_clean/1989/merged_struts_binders_floppy_1989_C_MC_NM_SF_LL.csv',
          row.names=FALSE)

#Emily Black
#Cleaning 1989 binder data - long_lake
...
#read in the long_lake lek data 
df_1 <- read.csv('raw_data/binders/long_lake_1989_capture_binder_data.csv', 
                 header=FALSE)
...
previous_strut <- read.csv("prelim_clean/binder_capture_data_1989_prelim_CL.csv")
...
#Write to save
write.csv(final_strut,  "prelim_clean/binder_capture_data_1989_prelim_CL_LL.csv", 
          row.names=FALSE)

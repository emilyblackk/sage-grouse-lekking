#Emily Black
#Cleaning 1987 binder data - mule creek
...
df_1 <- read.csv('raw_data/binders/mule_creek_1987_capture_binder_data.csv', 
                 header=FALSE)
...
previous_capture <- read.csv("prelim_clean/1987/binder_capture_data_1987_prelim_CL_BW_MS.csv")
...
full_capture[full_capture=="male "] <- 'male'

#Write to github
write.csv(full_capture, "prelim_clean/1987/binder_capture_data_1987_prelim_CL_BW_MS_MC.csv", 
          row.names=FALSE)

#Emily Black
#Cleaning 1987 strut data - north
...
df_1 <- read.csv('raw_data/binders/north_lek_1987_strut_binder_data.csv', 
                 header=FALSE)
...
#Remove row 29 - references handwritten sheet
df_1 <- df_1 %>%
  filter(!binder_pdf_page_number==29)
...
previous_strut <- read.csv('prelim_clean/1987/merged_struts_binders_floppy_1987_C_BW_MS.csv')
...
#write to computer
 write.csv(final_strut, 'prelim_clean/1987/merged_struts_binders_floppy_1987_C_BW_MS_N.csv',
           row.names=FALSE)

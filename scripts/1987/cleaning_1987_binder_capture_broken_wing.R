...
df_1 <- read.csv('raw_data/binders/broken_wing_1987_capture_binder_data.csv', 
                 header=FALSE)
...
previous_capture <- read.csv("prelim_clean/binder_capture_data_1987_prelim_CL.csv")
...
#Write to github
write.csv(full_capture, "prelim_clean/binder_capture_data_1987_prelim_CL_BW.csv", 
          row.names=FALSE)

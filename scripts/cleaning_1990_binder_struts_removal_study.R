...
previous_strut <- read.csv('prelim_clean/merged_struts_binders_floppy_MS_N_SF.csv')
...
#write to computer
write.csv(final_strut, 'prelim_clean/merged_struts_binders_floppy_MS_N_SF_RS.csv', 
          row.names=FALSE)

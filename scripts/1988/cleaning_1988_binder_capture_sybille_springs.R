#Emily Black
#Cleaning 1988 binder data - sybille_springs
...
#read in the sybille_springs lek data 
df_1 <- read.csv('raw_data/binders/sybille_springs_1988_capture_binder_data.csv', 
                 header=FALSE)
...
previous_strut <- read.csv("prelim_clean/binder_capture_data_1988_prelim_CL_RP_LL_WD_MS_N.csv") 
...
#Write to save
write.csv(final_strut,  "prelim_clean/binder_capture_data_1988_prelim_CL_RP_LL_WD_MS_N_SS.csv", 
          row.names=FALSE)

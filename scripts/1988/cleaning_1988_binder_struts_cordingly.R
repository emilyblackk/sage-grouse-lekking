#Emily Black
#Cleaning 1988 strut data - cordingly
...
df_1 <- read.csv('raw_data/binders/cordingly_1988_strut_binder_data.csv', 
                 header=FALSE)
...
# previous_strut <- read.csv('prelim_clean/1988/merged_struts_binders_floppy_1988_C_BW_MS_N_SF_WD.csv')
# 
# #merge the two
...
#write to computer
write.csv(filtered_df_full_join, 'prelim_clean/1988/merged_struts_binders_floppy_1988_C.csv',
          row.names=FALSE)

#Emily Black
#Cleaning 1988 strut data - sybille_springs
...
df_1 <- read.csv('raw_data/binders/sybille_springs_1988_strut_binder_data.csv', 
                 header=FALSE)
...
table(df_wider$type)
#there are 50 struts from the floppy, 
#and 67 in our dataframe
...
previous_strut <- read.csv('prelim_clean/1988/merged_struts_binders_floppy_1988_C_BW_RP_LL_WD_MS_N.csv')
...
#write to computer
write.csv(final_strut, 'prelim_clean/1988/merged_struts_binders_floppy_1988_C_BW_RP_LL_WD_MS_N_SS.csv',
          row.names=FALSE)

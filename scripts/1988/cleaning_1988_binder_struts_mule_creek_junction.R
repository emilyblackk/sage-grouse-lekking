#Emily Black
#Cleaning 1988 strut data - mule_creek_junction
...
df_1 <- read.csv('raw_data/binders/mule_creek_junction_1988_strut_binder_data.csv', 
                 header=FALSE)
...
table(df_wider$type)
#there are 11 struts from the floppy, 
#and 11 in our dataframe
...
previous_strut <- read.csv('prelim_clean/1988/merged_struts_binders_floppy_1988_C_BW_RP_LL_WD_MS_N_SS_V_SF.csv')
...
#write to computer
write.csv(final_strut, 'prelim_clean/1988/merged_struts_binders_floppy_1988_C_BW_RP_LL_WD_MS_N_SS_V_SF_MCJ.csv',
          row.names=FALSE)

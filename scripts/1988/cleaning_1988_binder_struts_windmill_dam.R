#Emily Black
#Cleaning 1988 strut data - windmill_dam
...
df_1 <- read.csv('raw_data/binders/windmill_dam_1988_strut_binder_data.csv', 
                 header=FALSE)
...
table(df_wider$type)
#there are 4 struts from the floppy, 
#and 4 in our dataframe
...
previous_strut <- read.csv('prelim_clean/1988/merged_struts_binders_floppy_1988_C_BW_RP_LL.csv')
...
#write to computer
write.csv(final_strut, 'prelim_clean/1988/merged_struts_binders_floppy_1988_C_BW_RP_LL_WD.csv',
          row.names=FALSE)

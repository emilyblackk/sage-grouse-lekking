#Emily Black
#Cleaning 1988 strut data - mud_springs
...
df_1 <- read.csv('raw_data/binders/mud_springs_1988_strut_binder_data.csv', 
                 header=FALSE)
...
previous_strut <- read.csv('prelim_clean/1988/merged_struts_binders_floppy_1988_C_BW_RP_LL_WD.csv')
...
#write to computer
write.csv(final_strut, 'prelim_clean/1988/merged_struts_binders_floppy_1988_C_BW_RP_LL_WD_MS.csv',
          row.names=FALSE)

#Emily Black
#Cleaning 1988 strut data - north
...
df_1 <- read.csv('raw_data/binders/north_1988_strut_binder_data.csv', 
                 header=FALSE)
...
table(df_wider$type)
#there are 135 struts from the floppy, 
...
previous_strut <- read.csv('prelim_clean/1988/merged_struts_binders_floppy_1988_C_BW_RP_LL_WD_MS.csv')
...
#write to computer
write.csv(final_strut, 'prelim_clean/1988/merged_struts_binders_floppy_1988_C_BW_RP_LL_WD_MS_N.csv',
          row.names=FALSE)

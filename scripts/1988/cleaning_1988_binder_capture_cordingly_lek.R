#Emily Black
#Cleaning 1988 binder data - cordingly
...
df_1 <- read.csv('raw_data/binders/cordingly_1988_capture_binder_data.csv', 
                 header=FALSE)
...
#Write to save
write.csv(df_1, "prelim_clean/binder_capture_data_1988_prelim_CL.csv", 
          row.names=FALSE)

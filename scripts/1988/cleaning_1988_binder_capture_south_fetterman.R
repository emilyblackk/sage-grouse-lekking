#Emily Black
#Cleaning 1988 binder data - south_fetterman
...
#read in the south_fetterman lek data 
df_1 <- read.csv('raw_data/binders/south_fetterman_1988_capture_binder_data.csv', 
                 header=FALSE)
...
df_1$total_num_lice_on_air_sacs[6] <- 2
...
previous_strut <- read.csv("prelim_clean/binder_capture_data_1988_prelim_CL_RP_LL_WD_MS_N_SS_V.csv") 
...
#Write to save
write.csv(final_strut,  "prelim_clean/binder_capture_data_1988_prelim_CL_RP_LL_WD_MS_N_SS_V_SF.csv", 
          row.names=FALSE)

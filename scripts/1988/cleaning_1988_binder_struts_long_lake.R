#Emily Black
#Cleaning 1988 strut data - long_lake
...
df_1 <- read.csv('raw_data/binders/long_lake_1988_strut_binder_data.csv', 
                 header=FALSE)
...
table(df_wider$type)
#there are 88 struts from the floppy, 
#and 100 in our dataframe
...
#manually fix an error in the floppies
strut_filtered$day <- ifelse(strut_filtered$month == '5' & strut_filtered$day =='8', '9', strut_filtered$day)
...
previous_strut <- read.csv('prelim_clean/1988/merged_struts_binders_floppy_1988_C_BW_RP.csv')
...
#write to computer
write.csv(final_strut, 'prelim_clean/1988/merged_struts_binders_floppy_1988_C_BW_RP_LL.csv',
          row.names=FALSE)

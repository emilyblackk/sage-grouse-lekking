#Emily Black
#Cleaning 1988 strut data - broken_wing_red_post
...
df_1 <- read.csv('raw_data/binders/broken_wing_red_post_1988_strut_binder_data.csv', 
                 header=FALSE)
...
previous_strut <- read.csv('prelim_clean/1988/merged_struts_binders_floppy_1988_C.csv')
...
#write to computer
write.csv(final_strut, 'prelim_clean/1988/merged_struts_binders_floppy_1988_C_BW_RP.csv',
          row.names=FALSE)
